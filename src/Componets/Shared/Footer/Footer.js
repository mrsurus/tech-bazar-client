...
const Footer = () => {
    return (
        <footer className="footer mt-5 footer-center p-10 bg-gray-400 text-base-content rounded">
            ...
            <div>
                <p className='text-red-600 font-bold'>Copyright © 2023 - All right reserved by Tech Bazar</p>
            </div>
        </footer>
    );
};
