...
const Banner = () => {
    return (
        ...
        <div className=' w-screen '>
            <div className='grid  mt-5 mx-3 md:mx-12  grid-cols-12  '>
                ...
                <div className='  col-span-6 md:col-span-3 grid grid-rows-6 gap-5'>
                    ...
                    <div className=' mt-5 md:mt-0 md:ml-5  row-span-3 h-full bg-no-repeat bg-cover' style={{ backgroundImage: `url(https://cdn.thewirecutter.com/wp-content/media/2021/04/wirelessheadsets-2048px-7353-2x1-1.jpg?auto=webp&quality=75&crop=2:1&width=1024)` }}>
                    ...
                    <div className='  mt-5 md:mt-0 md:ml-5 row-span-3 bg-no-repeat bg-cover  h-full' style={{ backgroundImage: `url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj-s1Ut-IAbvn0v0v0tWt4c1iMIG1kOo0yww&usqp=CAU)` }}>
                        <div className='ml-2 mt-3 w-24 my-5 bg-base-100 p-3  rounded'>
                ...
                <div className=' col-span-6 md:col-span-3 grid grid-rows-6 gap-5  '>
                    <div className=' mt-5 ml-5 md:mt-0 row-span-3 h-full '>
                        <img className='rounded h-full w-full' src="https://previews.123rf.com/images/rawpixel/rawpixel1810/rawpixel181004588/109572081-hand-holding-smartphone-and-bluetooth-speaker.jpg" alt="" />
                    </div>
                    <div className=' mt-5 ml-5 md:mt-0 row-span-3 h-full'>
